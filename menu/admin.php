<!-- log: update: 18/11/2020 status: done! by: TLA -->
...
<nav class="navbar navbar-expand-lg navbar-dark bg-warning menu">
    ...
    <div id="my-nav" class="collapse navbar-collapse">
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item"><button id="btnUser" class="btn btn-info" type="button">Quản Lý User</button></li>

            <li class="nav-item"><button id="btn_lsgd" class="btn btn-primary" type="button">LS Giao Dịch</button></li>

            <li class="nav-item"><button id="btn_tk" class="btn btn-secondary" type="button">Thống Kê</button></li>
